...
public class ChQosLogbackCoreAppenderAll {
    ...
    public ChQosLogbackCoreAppenderAll withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public ChQosLogbackCoreAppenderAll withM15Rate(Double m15Rate) {
        this.m15Rate = m15Rate;
        return this;
    }
    ...
    public ChQosLogbackCoreAppenderAll withM1Rate(Double m1Rate) {
        this.m1Rate = m1Rate;
        return this;
    }
    ...
    public ChQosLogbackCoreAppenderAll withM5Rate(Double m5Rate) {
        this.m5Rate = m5Rate;
        return this;
    }
    ...
    public ChQosLogbackCoreAppenderAll withMeanRate(Double meanRate) {
        this.meanRate = meanRate;
        return this;
    }
    ...
    public ChQosLogbackCoreAppenderAll withUnits(String units) {
        this.units = units;
        return this;
    }
    ...
    public ChQosLogbackCoreAppenderAll withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ChQosLogbackCoreAppenderAll.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChQosLogbackCoreAppenderAll) == false) {
            return false;
        }
        ChQosLogbackCoreAppenderAll rhs = ((ChQosLogbackCoreAppenderAll) other);
