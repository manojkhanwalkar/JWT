...
public class IoDropwizardJettyMutableServletContextHandler4xxResponses {
    ...
    public IoDropwizardJettyMutableServletContextHandler4xxResponses withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandler4xxResponses withM15Rate(Double m15Rate) {
        this.m15Rate = m15Rate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandler4xxResponses withM1Rate(Double m1Rate) {
        this.m1Rate = m1Rate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandler4xxResponses withM5Rate(Double m5Rate) {
        this.m5Rate = m5Rate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandler4xxResponses withMeanRate(Double meanRate) {
        this.meanRate = meanRate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandler4xxResponses withUnits(String units) {
        this.units = units;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandler4xxResponses withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IoDropwizardJettyMutableServletContextHandler4xxResponses.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IoDropwizardJettyMutableServletContextHandler4xxResponses) == false) {
            return false;
        }
        IoDropwizardJettyMutableServletContextHandler4xxResponses rhs = ((IoDropwizardJettyMutableServletContextHandler4xxResponses) other);
