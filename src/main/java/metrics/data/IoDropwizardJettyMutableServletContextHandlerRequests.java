...
public class IoDropwizardJettyMutableServletContextHandlerRequests {
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withMax(Double max) {
        this.max = max;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withMean(Double mean) {
        this.mean = mean;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withMin(Double min) {
        this.min = min;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withP50(Double p50) {
        this.p50 = p50;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withP75(Double p75) {
        this.p75 = p75;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withP95(Double p95) {
        this.p95 = p95;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withP98(Double p98) {
        this.p98 = p98;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withP99(Double p99) {
        this.p99 = p99;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withP999(Double p999) {
        this.p999 = p999;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withStddev(Double stddev) {
        this.stddev = stddev;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withM15Rate(Double m15Rate) {
        this.m15Rate = m15Rate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withM1Rate(Double m1Rate) {
        this.m1Rate = m1Rate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withM5Rate(Double m5Rate) {
        this.m5Rate = m5Rate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withMeanRate(Double meanRate) {
        this.meanRate = meanRate;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withDurationUnits(String durationUnits) {
        this.durationUnits = durationUnits;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withRateUnits(String rateUnits) {
        this.rateUnits = rateUnits;
        return this;
    }
    ...
    public IoDropwizardJettyMutableServletContextHandlerRequests withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IoDropwizardJettyMutableServletContextHandlerRequests.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IoDropwizardJettyMutableServletContextHandlerRequests) == false) {
            return false;
        }
        IoDropwizardJettyMutableServletContextHandlerRequests rhs = ((IoDropwizardJettyMutableServletContextHandlerRequests) other);
