...
public class ServicesAppAppResourceClaims {
    ...
    public ServicesAppAppResourceClaims withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withMax(Double max) {
        this.max = max;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withMean(Double mean) {
        this.mean = mean;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withMin(Double min) {
        this.min = min;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withP50(Double p50) {
        this.p50 = p50;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withP75(Double p75) {
        this.p75 = p75;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withP95(Double p95) {
        this.p95 = p95;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withP98(Double p98) {
        this.p98 = p98;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withP99(Double p99) {
        this.p99 = p99;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withP999(Double p999) {
        this.p999 = p999;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withStddev(Double stddev) {
        this.stddev = stddev;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withM15Rate(Double m15Rate) {
        this.m15Rate = m15Rate;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withM1Rate(Double m1Rate) {
        this.m1Rate = m1Rate;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withM5Rate(Double m5Rate) {
        this.m5Rate = m5Rate;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withMeanRate(Double meanRate) {
        this.meanRate = meanRate;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withDurationUnits(String durationUnits) {
        this.durationUnits = durationUnits;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withRateUnits(String rateUnits) {
        this.rateUnits = rateUnits;
        return this;
    }
    ...
    public ServicesAppAppResourceClaims withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ServicesAppAppResourceClaims.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ServicesAppAppResourceClaims) == false) {
            return false;
        }
        ServicesAppAppResourceClaims rhs = ((ServicesAppAppResourceClaims) other);
